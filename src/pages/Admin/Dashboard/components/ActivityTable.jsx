...
export default function ActivityTable() {
  ...
  return (
    <div className="rounded-2xl bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] ring-1 ring-slate-100">
      ...
      <div className="flex items-center justify-between px-6 py-6 border-b border-slate-50">
        <div>
           ...
           <p className="text-sm text-slate-400 mt-1">Memantau penggunaan sistem secara realtime</p>
        </div>
