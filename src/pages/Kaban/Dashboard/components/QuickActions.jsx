  ...
  const actions = [
    {
      ...
      iconBg: "bg-blue-50",
      mobileGradient: "from-blue-500/20 to-transparent",
    ...
    },
    {
      ...
      iconBg: "bg-rose-50",
      mobileGradient: "from-rose-500/20 to-transparent",
      borderColor: "border-rose-100",
    },
    {
      title: "Persetujuan Akses",
      shortTitle: "Persetujuan",
    ...
    },
    {
      ...
      iconBg: "bg-indigo-50",
      mobileGradient: "from-indigo-500/20 to-transparent",
